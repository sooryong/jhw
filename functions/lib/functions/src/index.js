...
exports.checkMigrationStatus = exports.migrateCustomerUsers = exports.sendVoice = exports.sendRcs = exports.sendFriendtalk = exports.sendAlimtalk = exports.getStatistics = exports.sendBulkSms = exports.getBalance = exports.sendSms = exports.deleteUserAccount = exports.changeUserPassword = exports.resetUserPassword = exports.createUserAccount = void 0;
...
// 마이그레이션 Functions (일회성 실행용)
var index_1 = require("./migrations/index");
Object.defineProperty(exports, "migrateCustomerUsers", { enumerable: true, get: function () { return index_1.migrateCustomerUsers; } });
Object.defineProperty(exports, "checkMigrationStatus", { enumerable: true, get: function () { return index_1.checkMigrationStatus; } });
