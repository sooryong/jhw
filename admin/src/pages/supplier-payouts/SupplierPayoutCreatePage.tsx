/**
 * 파일 경로: /src/pages/supplier-payments/SupplierPayoutCreatePage.tsx
 * 작성 날짜: 2025-10-14
 * 주요 내용: 공급사 지급 등록 페이지
 */
...
import { createPayout, getSupplierAccount } from '../../services/supplierPayoutService';
import type { Supplier } from '../../types/company';
import type { PayoutMethod } from '../../types/supplierPayout';
import { PAYOUT_METHOD_LABELS } from '../../types/supplierPayout';

const SupplierPayoutCreatePage = () => {
  ...
  const [payoutDate, setPaymentDate] = useState(() => {
...
export default SupplierPayoutCreatePage;
