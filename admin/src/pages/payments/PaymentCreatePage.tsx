...
import { createPayment, getCustomerAccount, type CreatePaymentData } from '../../services/customerPaymentService';
import { getCustomers } from '../../services/customerService';
import type { Customer } from '../../types/customer';
import type { PaymentMethod } from '../../types/customerPayment';
import { PAYMENT_METHOD_LABELS } from '../../types/customerPayment';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const paymentData: CreatePaymentData = {
        ...
        ...(formData.paymentMethod === 'tax_invoice' && formData.invoiceNumber && {
          taxInvoice: {
          ...
          <Box sx={{ p: 2 }}>
            <Paper sx={{ p: 3 }}>
              ...
              <form onSubmit={handleSubmit}>
                ...
                {/* 세금계산서 정보 (조건부) */}
                {formData.paymentMethod === 'tax_invoice' && (
                  <>
                    <TextField
                      label="세금계산서 번호"
