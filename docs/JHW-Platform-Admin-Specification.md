...
### 1.2 주요 특징
- **역할 기반 접근 제어**: admin, staff, customer 역할별 차별화된 기능 제공
...
- **고객사 (customer)**: 제한적 조회 권한 (향후 확장 예정)
...
interface Customer {
  ...
  smsRecipient: {
    person1: { name: string; mobile: NormalizedMobile; };
    person2?: { name: string; mobile: NormalizedMobile; };
  };
